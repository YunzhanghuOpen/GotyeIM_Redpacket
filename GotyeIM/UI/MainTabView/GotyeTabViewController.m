...
@interface GotyeTabViewController () <UITabBarControllerDelegate,
                                      GotyeOCDelegate>
...
- (void)viewDidLoad {
  ...
  [self.tabBar
      setSelectionIndicatorImage:[UIImage
                                     imageNamed:@"tab_button_select_back"]];
...
- (void)createMenuView {
  viewMenu =
      [[UIView alloc] initWithFrame:CGRectMake(ScreenWidth - 122, 5, 116, 93)];

  UIButton *button0 =
      [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 116, 50)];
  [button0 setBackgroundImage:[UIImage imageNamed:@"nav_menu_button_0"]
                     forState:UIControlStateNormal];
  [button0 setBackgroundImage:[UIImage imageNamed:@"nav_menu_button_0_down"]
                     forState:UIControlStateHighlighted];
  [button0 setImage:[UIImage imageNamed:@"nav_menu_icon_0"]
           forState:UIControlStateNormal];
  ...
  [button0 addTarget:self
                action:@selector(addFriendsClick:)
      forControlEvents:UIControlEventTouchUpInside];

  UIButton *button1 =
      [[UIButton alloc] initWithFrame:CGRectMake(0, 51, 116, 42)];
  [button1 setBackgroundImage:[UIImage imageNamed:@"nav_menu_button_1"]
                     forState:UIControlStateNormal];
  [button1 setBackgroundImage:[UIImage imageNamed:@"nav_menu_button_1_down"]
                     forState:UIControlStateHighlighted];
  [button1 setImage:[UIImage imageNamed:@"nav_menu_icon_1"]
           forState:UIControlStateNormal];
  ...
  [button1 addTarget:self
                action:@selector(startGroupClick:)
      forControlEvents:UIControlEventTouchUpInside];
...
- (void)addFriendsClick:(id)sender {
  GotyeAddFriendController *viewController =
      [[GotyeAddFriendController alloc] init];
...
- (void)startGroupClick:(id)sender {
  GotyeGroupCreateController *viewController =
      [[GotyeGroupCreateController alloc] init];
