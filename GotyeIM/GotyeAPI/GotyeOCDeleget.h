 ...
 * @param downloadMediaIfNeed: 是否需要下载
 */
-(void) onGetCSOfflineMessageList:(GotyeStatusCode)code msglist:(NSArray *)msgList downloadMediaIfNeed:(bool*)downloadMediaIfNeed;
 ...
 * @brief 新增客服评价通知
 */
-(void) onJudgeService:(int)sessionId;
/**
 * @brief 新增客服评价回调
 */
-(void) onReqJudgeCSO:(GotyeStatusCode)code;
 ...
 * @param code: 状态id
 * @param service: 客服组
 * @param creater: 客服组创建者
 */
-(void) onGetCSGroupDetail:(GotyeStatusCode)code service:(GotyeOCCustomerService *)service creater:(GotyeOCCustomerServiceCreater *)creater;
