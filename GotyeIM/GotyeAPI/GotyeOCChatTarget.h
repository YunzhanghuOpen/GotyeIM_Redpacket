 ...
 *  客服对象
 */
@interface GotyeOCCustomerServiceCreater : GotyeOCChatTarget

@property(nonatomic, copy) NSString* email;     ///< 客服账号
...
@property(nonatomic,retain) GotyeOCCustomerServiceCreater *creater;  ///< 客服组对象创建者
